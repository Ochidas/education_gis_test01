...
function showFinalResult() {
    ...
    quizContainer.innerHTML = `
        ...
        <p>GIS（地理情報システム）の本質は、空間的なデータを収集、分析、可視化することによって、場所に関連する情報を理解し、意思決定をサポートすることです。<br>
           ...
           GISを活用することで、河川管理の効率が向上し、より迅速かつ効果的な意思決定が可能になります。気候変動や災害への対応にもGISは必要不可欠です。</p>
        <p>DX技術の進化を受け入れて、有効に活用していきましょう。<br>
          「ゆく河の流れは絶えずして、しかももとの水にあらず」（鴨長明「方丈記」）</p>
        <p>作成者：越智貴政　（株式会社荒谷建設コンサルタント、空間情報総括監理技術者、スペーシャリストの会中四国支部長）<br>
           このテストアプリは、生成AIを活用して作成しています。</p>
